...
/*  Function to search for the first occurence of a bigon. If found, returns  *
 *  the component number and sets the crossing as the first crossing of the   *
 *  component. If not found, L is unchanged and -1 is returned                *
 *                                                                            *
...
int bigon_search(const struct link* L)
{
    ...
    for (component = 0; component < L->number_of_components; ++component)
    {
        ...
        /*  This will be decremented by 1 if the crossing will be visitied    *
         *  twice, by 2 otherwise.                                            */
